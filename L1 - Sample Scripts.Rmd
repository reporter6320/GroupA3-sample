...
# DISTRIBUTIONS
plotting PDFs and CFDs for a normal distribution:
```{r}
...
plot(xvec, fx, type = "l", lty = 1, col="red", ylab = "p(x)", xlab = "x")
...
# Let’s filter the data for adult males (more on why later)
